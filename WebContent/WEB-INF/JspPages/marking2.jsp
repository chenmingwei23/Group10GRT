...
<body>
    ...
    <p style="text-align:left; padding-left: 20px"> <a href="http://localhost:8080/group10/marking"> Next tournament </a>
    <span style="float: right; padding-right: 20px"> <a href="http://localhost:8080/group10/marking3"> Previous tournament </a>
    </span>
    </p>

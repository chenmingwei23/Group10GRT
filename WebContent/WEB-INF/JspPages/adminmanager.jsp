...
<head>
  ...
  <title>Admin Management-G​RAND​ R​UNETERRA​ T​AVERN​</title>
    ...
    <nav class="my-navbar" role="navigation">  
        <div class="container-fluid">  
            <div class="navbar-header">  
                ...
                <a class="navbar-brand" href="/grt/adminmanager" title="翼风之下"><img src="/bbs/brand.png" style="position: relative;top: -30px;"></a>  
            </div>  
            <div class="collapse navbar-collapse" id="example-navbar-collapse"> 
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown">
                   ...
                   <img src="/bbs/default/default_user.jpg" style="width:30px;height:25px; border-radius: 50%;"></a>
                   <ul class="dropdown-menu" role="menu" style="background-color: rgba(0,0,0,.65);">
                    <li class="dropdown-header" style="color: red;">管理员：${admin.getAdmin() }</li>
                    <li><a href="javascript:void(0)">登录时间：<fmt:formatDate type="both" value="${admin.getLoginTime() }" /></a></li>
                    <li><a href="javascript:void(0)">上次登录时间：<fmt:formatDate type="both" value="${admin.getLoginOldTime() }" /></a></li>
                    <li><a href="javascript:void(0)">IP地址：${admin.getLoginIp() }</a></li>
                    <li class="divider"></li>
                    <li><a href="${pageContext.request.contextPath }/adminlogout${admin.getId()}"><button class="btn btn-block btn-danger">退出登录</button></a></li>
                   </ul>
                  </li>
                </ul>
            </div>  
  ...
  <div class="row clearfix">
    ...
    <div class="col-md-2 column" style="background-color: #00BCD4;">
      <div class="thumbnails" style="text-align: center;">
        <img alt="120x120" src="/bbs/default/default_user.jpg" class="img-circle" style="width: 120px; height: 120px;">
        <div class="caption">
          <h4> <b>${admin.getAdmin() }</b></h4>
          <h6> 管理员 </h6>
    ...
    <div class="col-md-10 column">
      ...
      <div id="welcome" style="display: block;">
        <div class="jumbotron">
          <h1>Hello，${admin.getAdmin() }</h1>
          <p>欢迎登录翼风之下社区论坛后台管理平台。</p>
          <p>该平台提供用户信息、帖子内容、用户回帖的一些添加、修改、删除简单操作。</p>
        </div>
      ...
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <input type="text" name="id" value="${tu.getId() }" class="form-control">
            </td>
            <td>
            ...
            <td>
              <input type="tel" name="phone" value="${tu.getPhone() }" class="form-control">
            </td>
            <td>
              <input type="tel" name="qq" value="${tu.getQq() }" class="form-control">
            </td>
            <td>
      ...
      <table class="table table-hover table-bordered">
        ...
        <c:forEach items="${listtp }" var="tp" begin="0" end="9">
          <tr>
            <td>
              <input type="text" name="id" value="${tp.getId()}" class="form-control">
            </td>
            <td>
              <input type="text" name="forumId" value="${tp.getId() }" class="form-control">
            </td>
           <td>
              <input type="text" name="userId" value="${tp.getId() }" class="form-control">
            </td>
            <td>
              <input type="text" name="Title" value="${tp.getTitle()}" class="form-control">
            </td>
            <td>
            	<fmt:formatDate type="both" value="${tp.getTime()}" />
            </td>
            <td>
              <input type="text" name="pic" value="${tp.getPic()}" class="form-control">
            </td>
            <td>
              <button type="button" class="btn btn-success" title="修改"><span class="glyphicon glyphicon-ok"></span></button>&nbsp;&nbsp;&nbsp;&nbsp;
              <button type="button" class="btn btn-danger" title="删除"><span class="glyphicon glyphicon-remove"></span></button>
      ...
      <table class="table table-hover table-bordered">
        ...
        <c:forEach items="${listtr }" var="tr" begin="0" end="9">
          <tr>
            <td>
              <input type="text" name="id" value="${tr.getId() }" class="form-control">
            </td>
            <td>
              <input type="text" name="postId" value="${tr.getPostId() }" class="form-control">
            </td>
            <td>
              <input type="text" name="userId" value="${tr.getUserId() }" class="form-control">
            </td>
            <td>
              <input type="text" name="floor" value="${tr.getFloor() }" class="form-control">
            </td>
            <td>
              <fmt:formatDate type="both" value="${tr.getTime()}" />
            </td>
            <td>
              <button type="button" class="btn btn-success" title="修改"><span class="glyphicon glyphicon-ok"></span></button>&nbsp;&nbsp;&nbsp;&nbsp;
              <button type="button" class="btn btn-danger" title="删除"><span class="glyphicon glyphicon-remove"></span></button>
